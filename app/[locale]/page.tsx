        ...
        <main className="relative mx-auto flex w-full max-w-6xl flex-col gap-16 px-4 pb-20 sm:gap-20 sm:px-8 lg:px-10">
            ...
            <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
              <div>
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  {(["privacy1", "privacy2", "privacy3", "privacy4"] as const).map((key) => (
                    <div
                      key={key}
                    ...
                    >
                      ...
                      <p className="text-sm leading-6 text-slate-600">{t(key)}</p>
                    </div>
                  ))}
                </div>
              </div>
              <div className="grid gap-4">
                {[
                  { titleKey: "dataControl" as const, bodyKey: "dataControlBody" as const },
                  { titleKey: "privacy2" as const, bodyKey: "inferenceBody" as const },
                  { titleKey: "privacy4" as const, bodyKey: "confidentialityBody" as const },
                ].map((item) => (
                  <div
                    key={item.titleKey}
          ...
          <section className="grid gap-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {(["learn1", "learn2", "learn3", "learn4", "learn5", "learn6"] as const).map((key) => (
                <div
                  key={key}
